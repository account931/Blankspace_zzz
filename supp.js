...
//Click Example  Button
    ...
    $("#coordsInput").val(" Lilly awoke  in an evening dress and opera cloak. \n In her hand were five playing cards. \n They were were, the queen  of spades, four of clubs, \n nine of clubs , three of hearts, nine of hearts."); //  was \n  in the  end
...
// START HEADER  CHANGE HOVER HEADER Change -> Waze Check Apllication******
  $('#headX').hover(function(){    
   ...
   $("#textChange").stop().fadeOut(900,function(){  $(this).html("<span style='color:red;'>Removes blankspaces</span> ") }).fadeIn(900);
...
function(){ //hover off
          ...
          $("#textChange").stop().fadeOut(900,function(){  $(this).html("Double blankspace removal") }).fadeIn(900);
